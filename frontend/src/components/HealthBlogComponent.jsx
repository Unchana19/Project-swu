        ...
        <Link className="w-full h-[300px] col-span-12 sm:col-span-6" to={`/Health-Information/${id}`}>
            <Card isFooterBlurred className="w-full h-[300px]">
                <CardHeader className="absolute z-10 top-1 flex-col items-start">
                    <p className="text-tiny text-white/60 uppercase font-bold">Health Information</p>
                    <h4 className="text-green-200 font-medium text-xl">{title}</h4>
                </CardHeader>
                <Image
                    isZoomed
                    removeWrapper
                ...
                <CardFooter className="absolute bg-black/40 bottom-0 z-10 border-t-1 border-default-600 dark:border-default-100">
                    ...
                    <Button color="success" radius="full" size="sm">อ่านเพิ่มเติม</Button>
                </CardFooter>
            </Card>
        </Link>
    )
